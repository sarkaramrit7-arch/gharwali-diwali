...
// MVP Modal Functions
window.showMVPModal = async function() {
    ...
    try {
        ...
        if (mvpData && (mvpData.gold || mvpData.silver || mvpData.bronze)) {
            let html = '';
            
            // Gold Medal
            if (mvpData.gold && mvpData.gold.name) {
                html += `
                    <div class="mvp-player-card gold">
                        <div class="mvp-medal">🥇</div>
                        <div class="mvp-player-info">
                            <div class="mvp-player-name">${mvpData.gold.name}</div>
                            <div class="mvp-player-team">Team ${mvpData.gold.team}</div>
                        </div>
                    </div>
                `;
            }
            ...
            // Silver Medal
            if (mvpData.silver && mvpData.silver.name) {
                html += `
                    <div class="mvp-player-card silver">
                        <div class="mvp-medal">🥈</div>
                        <div class="mvp-player-info">
                            <div class="mvp-player-name">${mvpData.silver.name}</div>
                            <div class="mvp-player-team">Team ${mvpData.silver.team}</div>
                        </div>
                    </div>
                `;
            }
            ...
            // Bronze Medal
            if (mvpData.bronze && mvpData.bronze.name) {
                html += `
                    <div class="mvp-player-card bronze">
                        <div class="mvp-medal">🥉</div>
                        <div class="mvp-player-info">
                            <div class="mvp-player-name">${mvpData.bronze.name}</div>
                            <div class="mvp-player-team">Team ${mvpData.bronze.team}</div>
                        </div>
                    </div>
                `;
            }
...
window.closeMVPModal = function(event) {
    const modal = document.getElementById('mvpModal');
